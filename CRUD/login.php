    ...
    <header>
            ...
            <ul class="nav justify-content nav">
                ...
                <li class="nav-item">
                    <a class="nav-link" href="#">
                        <button type="button" class="btn btn-outline-secondary desce">
                ...
                <li class="nav-item">
                    <a class="nav-link" href="#">
                        <button type="button" class="btn btn-outline-success desce">
        ...
        <section>
            ...
            <div class="d-grid gap-2 inscreva">                
                <button class="btn btn-outline-danger" type="button"><strong>ESQUECI MINHA SENHA</strong></button>
                <button class="btn btn-outline-primary" type="button"><strong>CADASTRE-SE</strong></button>
              </div>
        </section>            
    </body>
>>>>>>> Stashed changes
