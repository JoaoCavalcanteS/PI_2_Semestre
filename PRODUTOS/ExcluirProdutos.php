...
<body>
    ...
    <Form Action="ExcluirProdutoProcesso.php?id=<?php echo $id ?>" method="POST">
        ...
        <div class="input-group mb-3">
            <span class="input-group-text" id="basic-addon1">Código do Produto : <?php echo $PRODUTO ?></span>
            <br>
            <span class="input-group-text" id="basic-addon1">Nome do Produto: <?php echo $textname ?></span>
